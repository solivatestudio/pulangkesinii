...
import { CalendarDays, ChevronDown, ChevronRight, Globe2, HandHeart, Handshake, HelpCircle, Instagram, Linkedin, Mail, MapPin, Menu, MessageCircle, Route, Search, Tag, X } from 'lucide-react';
...
const categories = ['Semua', 'Volunteer', 'Voluntrip', 'Fun Activity'];
